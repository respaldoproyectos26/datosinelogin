...
// (opcional) permisos
#require_permission('ver_formulario2');

// Página: Nuevo registro (solo formulario)
$pageTitle  = 'Nuevo registro RC';
$pageHeader = 'Nuevo registro RC';
...
// Script RC
$scriptPath = FORM2_DIR . '/js/script.js';
$scriptVersion = file_exists($scriptPath) ? filemtime($scriptPath) : time();
$customScripts[] =
  '<script src="'.FORM_DATOS2_URL.'/js/script.js?v='.$scriptVersion.'" defer></script>';
// Tom-select
...
$FORM_FLAGS = [
  'show_dtto_fed'        => false,
  'show_dtto_loc'        => false,
  'show_municipio_form'  => false, // ajusta si RC lo requiere o no

  'show_tipo_nombramiento'=> true,
  'tipo_propietario'     => true,
  'tipo_suplente'        => true,

  'show_num_ruta'        => false,
  'show_secciones_ruta'  => false,
  'show_seccion_rc'      => true,  // reusa secciones_ruta como "Sección"
];
...
<?php
$file = path_join(FILT_DATOS2_URL,'index.php');
$version = file_exists($file) ? filemtime($file) : time();
?>
<div class="d-flex align-items-center w-100 justify-content-center mb-3">
  <a href="../filtrodatos2/" class="btn btn-warning fw-bolder">Cancelar</a>
  <!--<a href="../filtrodatos2/?= <?=  $version ?>" class="btn btn-warning fw-bolder">Cancelar</a>-->
</div>
 ...
 <div class="row g-3 align-items-end justify-content-center">
  ...
  <div class="col-md-4 d-none">
    ...
    <select name="figura" id="figura" class="form-select" required>
      <option value="RG" class="d-none">RC</option>
      <option value="RC" selected>RG</option>
      <option class="d-none" value="PROMOVIDO">PROMOVIDO</option>
    </select>
  </div>
