...
$tabla   = 'registrorepdistloc';

$id    = (int)($_POST['id'] ?? 0);    // id de registrorepdistloc
...
$figura = figura_norm($_POST['figura'] ?? 'REP DIST LOC');
...
try {
  if ($id === 0) {
    ...
    // INSERT registrorepdistloc (requiere que hayas agregado id_reglogin a la tabla)
