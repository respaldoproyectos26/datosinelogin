...
// (opcional) permisos
#require_permission('ver_formulario3');

// Página: Nuevo registro (solo formulario)
$pageTitle  = 'Nuevo registro PROMOVIDO';
$pageHeader = 'Nuevo registro PROMOVIDO';
...
// Script RC
$scriptPath = FORM3_DIR . '/js/script.js';
$scriptVersion = file_exists($scriptPath) ? filemtime($scriptPath) : time();
$customScripts[] =
  '<script src="'.FORM_DATOS3_URL.'/js/script.js?v='.$scriptVersion.'" defer></script>';
// Tom-select
...
<?php
$file = path_join(FILT_DATOS3_URL,'index.php');
$version = file_exists($file) ? filemtime($file) : time();
?>
<div class="d-flex align-items-center w-100 justify-content-center mb-3">
  <a href="../filtrodatos3/" class="btn btn-warning fw-bolder">Cancelar</a>
  <!--<a href="../filtrodatos3/?= <?=  $version ?>" class="btn btn-warning fw-bolder">Cancelar</a>-->
</div>
 ...
 <div class="row g-3 align-items-end justify-content-center">
  ...
  <div class="col-md-4 d-none">
    ...
    <select name="figura" id="figura" class="form-select" required>
      ...
      <option value="PROMOVIDO" selected>PROMOVIDO</option>
    </select>
  </div>
