...
$(function () {
  ...
  // Botón DataTables "Crear" -> redirige al formulario Municipal
  ...
  $.fn.dataTable.ext.buttons.crear = {
    ...
    action: () => {
      ...
      if (modalEl && formEl) {
        ...
        window.location.href = '../formMunicipal/index.php';
      }
    }
  };
  ...
  $('#productsTable').on('click', '.editar-btn', function () {
    ...
    window.location.href = `../formMunicipal/index.php?id=${encodeURIComponent(id)}`;
  });
