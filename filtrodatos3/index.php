...
$customScripts = [
    ...
    '<script src="'.asset('filtrodatos3/js/script.js').'"></script>',
];
################################################################################################

// 👉 Aquí defines el título y encabezado dinámico
$pageTitle = 'Filtros Datos Representante Municipal';
$pageTitle = 'Filtros Datos Promovidos';
$pageHeader = 'Datos Promovidos';
