...
// (opcional) permisos
#require_permission('ver_formDistFed');

// Página: Nuevo registro (solo formulario)
$pageTitle  = 'Nuevo registro Rep. Distrital Federal';
$pageHeader = 'Registro Rep. Distrital Federal';
...
// Script Dist. Fed.
$scriptPath = FORM_DISTFED_DIR . '/js/script.js';
$scriptVersion = file_exists($scriptPath) ? filemtime($scriptPath) : time();
$customScripts[] =
  '<script src="'.FORM_DISTFED_URL.'/js/script.js?v='.$scriptVersion.'" defer></script>';
// Tom-select
...
<?php
$file = path_join(FILTRO_FE_DIR,'index.php');
...
<div class="d-flex align-items-center w-100 justify-content-center mb-3">
  ...
  <!--<a href="../filtDistFed/?= <?=  $version ?>" class="btn btn-warning fw-bolder">Cancelar</a>-->
</div>
 ...
 <div class="row g-3 align-items-end justify-content-center">
  ...
  <div class="col-md-4 d-none">
    ...
    <select name="figura" id="figura" class="form-select" required>
      ...
      <option value="distfed" selected>Distrital Federal</option>
