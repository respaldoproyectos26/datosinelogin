...
$customScripts = [
    ...
    '<script src="'.asset('filtDistFed/js/script.js').'"></script>',
];
################################################################################################

// 👉 Aquí defines el título y encabezado dinámico
$pageTitle = 'Filtros Datos Representante Distrital Federal';
$pageHeader = 'Datos Representante Distrital Federal';
